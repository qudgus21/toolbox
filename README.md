...
**[toolpop.org](https://toolpop.org)** — 241개 도구 × 45개 언어를 지원하는 온라인 도구 플랫폼
...
- **5개 카테고리** — PDF (43) · Image (56) · Text (44) · Converter (48) · Calculator (50)
- **241개 도구 × 45개 로케일 = 10,845+ 페이지** SEO 대응
- **166,000+ 라인** 번역 사전 (카테고리별 분리, Dynamic Import)

## 설계 및 구현

### 9,990 페이지 SEO — Vercel 80MB 빌드 제한

241개 도구 × 45개 로케일 = 10,845개 페이지를 모두 정적 생성하면 Vercel의 빌드 Output 제한을 초과합니다.
...
241개 도구의 UI 일관성을 위해 자체 디자인 토큰 시스템을 구축했습니다.
