    ...
    >
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/50 to-transparent px-1 pb-0.5 pt-3">
          <span className={cn(
            "text-[10px] font-bold",
            isDeleted ? "text-red-300 line-through" : "text-white",
          )}>
            {pageNum}
          </span>
        </div>
...
interface DeletePagesPreviewProps {
  file: File;
  pageCount: number;
...
export function DeletePagesPreview({
  file,
  pageCount,
  deletedPages,
  orderedPages,
