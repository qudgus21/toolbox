const CACHE_NAME = "toolpop-calculator-v1";
const STATIC_ASSETS = ["/calculator/manifest.json", "/calculator/favicon.svg"];
...
self.addEventListener("fetch", (event) => {
  ...
  // Only cache same-origin static assets under /calculator/ path
  const isCalculatorAsset =
