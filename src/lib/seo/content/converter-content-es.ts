...
export const converterContentEs: ToolContentMap = {
  // Unit Converters
  "length": {
    howTo: {
      title: "Cómo Convertir Unidades de Longitud",
      steps: [
  ...
  "weight": {
    howTo: {
      title: "Cómo Convertir Unidades de Peso",
      steps: [
  ...
  "temperature": {
    howTo: {
      title: "Cómo Convertir Temperatura",
      steps: [
  ...
  "area": {
    howTo: {
      title: "Cómo Convertir Unidades de Área",
      steps: [
  ...
  "volume": {
    howTo: {
      title: "Cómo Convertir Unidades de Volumen",
      steps: [
  ...
  "speed": {
    howTo: {
      title: "Cómo Convertir Unidades de Velocidad",
      steps: [
  ...
  "pressure": {
    howTo: {
      title: "Cómo Convertir Unidades de Presión",
      steps: [
  ...
  "energy": {
    howTo: {
      title: "Cómo Convertir Unidades de Energía",
      steps: [
  ...
  "number-base": {
    howTo: {
      title: "Cómo Convertir Entre Bases Numéricas",
      steps: [
  ...
  "color-converter": {
    howTo: {
      title: "Cómo Convertir Formatos de Color",
      steps: [
  ...
  "json-yaml": {
    howTo: {
      title: "Cómo Convertir JSON a YAML",
      steps: [
  ...
  "json-csv": {
    howTo: {
      title: "Cómo Convertir JSON a CSV",
      steps: [
  ...
  "json-xml": {
    howTo: {
      title: "Cómo Convertir JSON a XML",
      steps: [
  ...
  "json-toml": {
    howTo: {
      title: "Cómo Convertir JSON a TOML",
      steps: [
  ...
  "css-unit": {
    howTo: {
      title: "Cómo Convertir Unidades CSS",
      steps: [
