...
export const textContentFr: ToolContentMap = {
  "word-counter": {
    howTo: {
      title: "Comment compter les mots",
      steps: [
  ...
  "character-counter": {
    howTo: {
      title: "Comment compter les caractères",
      steps: [
  ...
  "text-statistics": {
    howTo: {
      title: "Comment analyser les statistiques textuelles",
      steps: [
  ...
  "keyword-density": {
    howTo: {
      title: "Comment analyser la densité des mots-clés",
      steps: [
  ...
  "find-duplicates": {
    howTo: {
      title: "Comment trouver les lignes dupliquées",
      steps: [
  ...
  "case-converter": {
    howTo: {
      title: "Comment convertir la casse du texte",
      steps: [
  ...
  "reverse-text": {
    howTo: {
      title: "Comment inverser le texte",
      steps: [
  ...
  "text-repeater": {
    howTo: {
      title: "Comment répéter le texte",
      steps: [
  ...
  "text-sort": {
    howTo: {
      title: "Comment trier les lignes de texte",
      steps: [
  ...
  "remove-duplicates": {
    howTo: {
      title: "Comment supprimer les lignes en double",
      steps: [
  ...
  "add-line-numbers": {
    howTo: {
      title: "Comment ajouter les numéros de ligne",
      steps: [
  ...
  "add-prefix-suffix": {
    howTo: {
      title: "Comment ajouter le préfixe et le suffixe",
      steps: [
  ...
  "join-text": {
    howTo: {
      title: "Comment joindre les lignes de texte",
      steps: [
  ...
  "split-text": {
    howTo: {
      title: "Comment fractionner le texte",
      steps: [
  ...
  "remove-line-breaks": {
    howTo: {
      title: "Comment supprimer les sauts de ligne",
      steps: [
  ...
  "remove-extra-spaces": {
    howTo: {
      title: "Comment supprimer les espaces supplémentaires",
      steps: [
  ...
  "remove-empty-lines": {
    howTo: {
      title: "Comment supprimer les lignes vides",
      steps: [
  ...
  "remove-special-characters": {
    howTo: {
      title: "Comment supprimer les caractères spéciaux",
      steps: [
  ...
  "remove-emojis": {
    howTo: {
      title: "Comment supprimer les emojis",
      steps: [
  ...
  "remove-html-tags": {
    howTo: {
      title: "Comment supprimer les balises HTML",
      steps: [
  ...
  "remove-accents": {
    howTo: {
      title: "Comment supprimer les accents",
      steps: [
  ...
  "url-extractor": {
    howTo: {
      title: "Comment extraire les URL",
      steps: [
  ...
  "number-extractor": {
    howTo: {
      title: "Comment extraire les nombres",
      steps: [
  ...
  "lorem-ipsum": {
    howTo: {
      title: "Comment générer Lorem Ipsum",
      steps: [
