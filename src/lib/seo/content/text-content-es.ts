...
export const textContentEs: ToolContentMap = {
  "word-counter": {
    howTo: {
      title: "Cómo Contar Palabras",
      steps: [
  ...
  "text-statistics": {
    howTo: {
      title: "Cómo Analizar Estadísticas de Texto",
      steps: [
  ...
  "find-duplicates": {
    howTo: {
      title: "Cómo Buscar Líneas Duplicadas",
      steps: [
  ...
  "case-converter": {
    howTo: {
      title: "Cómo Convertir Mayúsculas/Minúsculas de Texto",
      steps: [
  ...
  "text-sort": {
    howTo: {
      title: "Cómo Ordenar Líneas de Texto",
      steps: [
  ...
  "remove-duplicates": {
    howTo: {
      title: "Cómo Remover Líneas Duplicadas",
      steps: [
  ...
  "add-line-numbers": {
    howTo: {
      title: "Cómo Añadir Números de Línea",
      steps: [
  ...
  "add-prefix-suffix": {
    howTo: {
      title: "Cómo Añadir Prefijo y Sufijo",
      steps: [
  ...
  "join-text": {
    howTo: {
      title: "Cómo Unir Líneas de Texto",
      steps: [
  ...
  "remove-line-breaks": {
    howTo: {
      title: "Cómo Remover Saltos de Línea",
      steps: [
  ...
  "remove-extra-spaces": {
    howTo: {
      title: "Cómo Remover Espacios Extras",
      steps: [
  ...
  "remove-empty-lines": {
    howTo: {
      title: "Cómo Remover Líneas Vacías",
      steps: [
  ...
  "remove-special-characters": {
    howTo: {
      title: "Cómo Remover Caracteres Especiales",
      steps: [
  ...
  "remove-html-tags": {
    howTo: {
      title: "Cómo Remover Etiquetas HTML",
      steps: [
  ...
  "find-and-replace": {
    howTo: {
      title: "Cómo Buscar y Reemplazar Texto",
      steps: [
  ...
  "regex-tester": {
    howTo: {
      title: "Cómo Probar Expresiones Regulares",
      steps: [
  ...
  "lorem-ipsum": {
    howTo: {
      title: "Cómo Generar Lorem Ipsum",
      steps: [
