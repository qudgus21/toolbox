...
export const textContentRu: ToolContentMap = {
  "word-counter": {
    howTo: {
      title: "Как подсчитать слова",
      steps: [
  ...
  "text-statistics": {
    howTo: {
      title: "Как анализировать статистику текста",
      steps: [
  ...
  "keyword-density": {
    howTo: {
      title: "Как анализировать плотность ключевых слов",
      steps: [
  ...
  "find-duplicates": {
    howTo: {
      title: "Как найти дублирующиеся строки",
      steps: [
  ...
  "case-converter": {
    howTo: {
      title: "Как преобразовать регистр текста",
      steps: [
  ...
  "text-sort": {
    howTo: {
      title: "Как сортировать текстовые строки",
      steps: [
  ...
  "remove-duplicates": {
    howTo: {
      title: "Как удалить дублирующиеся строки",
      steps: [
  ...
  "add-line-numbers": {
    howTo: {
      title: "Как добавить номера строк",
      steps: [
  ...
  "add-prefix-suffix": {
    howTo: {
      title: "Как добавить префикс и суффикс",
      steps: [
  ...
  "join-text": {
    howTo: {
      title: "Как объединить текстовые строки",
      steps: [
  ...
  "remove-line-breaks": {
    howTo: {
      title: "Как удалить разрывы строк",
      steps: [
  ...
  "remove-extra-spaces": {
    howTo: {
      title: "Как удалить дополнительные пробелы",
      steps: [
  ...
  "remove-empty-lines": {
    howTo: {
      title: "How to Remove Empty Lines",
      steps: [
  ...
  "find-and-replace": {
    howTo: {
      title: "Как найти и заменить Text",
      steps: [
