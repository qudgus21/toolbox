...
export const converterContentPt: ToolContentMap = {
  // Unit Converters
  "length": {
    howTo: {
  ...
  "temperature": {
    howTo: {
      title: "Como Converter Temperatura",
      steps: [
  ...
  "scientific-notation": {
    howTo: {
      title: "Como Converter Notação Científica",
      steps: [
  ...
  "css-unit": {
    howTo: {
      title: "Como Converter Unidades CSS",
      steps: [
