...
export const pdfContentTr: ToolContentMap = {
  merge: {
    howTo: {
  ...
  "pdf-to-jpg": {
    howTo: {
      title: "PDF Nasıl JPG'ye Dönüştürülür",
      steps: [
  ...
  "jpg-to-pdf": {
    howTo: {
      title: "JPG Nasıl PDF'ye Dönüştürülür",
      steps: [
  ...
  rotate: {
    howTo: {
      title: "PDF Sayfaları Nasıl Döndürülür",
      steps: [
  ...
  watermark: {
    howTo: {
      title: "PDF'ye Nasıl Filigran Eklenir",
      steps: [
  ...
  protect: {
    howTo: {
      title: "PDF Nasıl Şifresi ile Korunur",
      steps: [
  ...
  "delete-pages": {
    howTo: {
      title: "PDF'den Sayfalar Nasıl Silinir",
      steps: [
  ...
  "extract-images": {
    howTo: {
      title: "PDF'den Görüntüler Nasıl Çıkarılır",
      steps: [
  ...
  "pdf-to-png": {
    howTo: {
      title: "PDF Nasıl PNG'ye Dönüştürülür",
      steps: [
  ...
  "pdf-to-text": {
    howTo: {
      title: "PDF'den Metin Nasıl Çıkarılır",
      steps: [
  ...
  "html-to-pdf": {
    howTo: {
      title: "HTML Nasıl PDF'ye Dönüştürülür",
      steps: [
  ...
  "png-to-pdf": {
    howTo: {
      title: "PNG Nasıl PDF'ye Dönüştürülür",
      steps: [
  ...
  "image-to-pdf": {
    howTo: {
      title: "Görüntü Nasıl PDF'ye Dönüştürülür",
      steps: [
  ...
  "webp-to-pdf": {
    howTo: {
      title: "WebP Nasıl PDF'ye Dönüştürülür",
      steps: [
  ...
  "tiff-to-pdf": {
    howTo: {
      title: "TIFF Nasıl PDF'ye Dönüştürülür",
      steps: [
  ...
  "heic-to-pdf": {
    howTo: {
      title: "HEIC Nasıl PDF'ye Dönüştürülür",
      steps: [
  ...
  "extract-pages": {
    howTo: {
      title: "PDF'den Sayfalar Nasıl Çıkarılır",
      steps: [
  ...
  "scan-to-pdf": {
    howTo: {
      title: "Belgeler Nasıl PDF'ye Taranır",
      steps: [
  ...
  "page-numbers": {
    howTo: {
      title: "PDF'ye Nasıl Sayfa Numarası Eklenir",
      steps: [
        "Upload your PDF file.",
  ...
  crop: {
    howTo: {
      title: "PDF Sayfaları Nasıl Kesilir",
      steps: [
        "Upload your PDF file.",
  ...
  resize: {
    howTo: {
      title: "PDF Nasıl Yeniden Boyutlandırılır",
      steps: [
        "Upload your PDF document.",
  ...
  "edit-metadata": {
    howTo: {
      title: "PDF Meta Verileri Nasıl Düzenlenir",
      steps: [
        "Upload your PDF file.",
  ...
  "pages-per-sheet": {
    howTo: {
      title: "Bir Sayfada Birden Fazla Sayfa Nasıl Yazdırılır",
      steps: [
        "Upload your PDF document.",
  ...
  "header-footer": {
    howTo: {
      title: "PDF'ye Nasıl Başlık ve Alt Bilgi Eklenir",
      steps: [
        "Upload your PDF document.",
  ...
  grayscale: {
    howTo: {
      title: "PDF Nasıl Gri Tonlamaya Dönüştürülür",
      steps: [
  ...
  booklet: {
    howTo: {
      title: "PDF Opusku Nasıl Oluşturulur",
      steps: [
        "Upload your PDF document.",
