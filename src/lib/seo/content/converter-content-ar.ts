...
export const converterContentAr: ToolContentMap = {
  // Unit Converters
  "length": {
    howTo: {
  ...
  "temperature": {
    howTo: {
      title: "كيفية تحويل درجة الحرارة",
      steps: [
  ...
  "time": {
    howTo: {
      title: "How to Convert Time Units",
      steps: [
  ...
  "pressure": {
    howTo: {
      title: "How to Convert Pressure Units",
      steps: [
  ...
  "energy": {
    howTo: {
      title: "How to Convert Energy Units",
      steps: [
  ...
  "power": {
    howTo: {
      title: "How to Convert Power Units",
      steps: [
  ...
  "frequency": {
    howTo: {
      title: "How to Convert Frequency Units",
      steps: [
  ...
  "angle": {
    howTo: {
      title: "How to Convert Angle Units",
      steps: [
  ...
  "data-storage": {
    howTo: {
      title: "How to Convert Data Storage Units",
      steps: [
  ...
  "fuel-economy": {
    howTo: {
      title: "How to Convert Fuel Economy",
      steps: [
  ...
  "number-base": {
    howTo: {
      title: "How to Convert Between Number Bases",
      steps: [
  ...
  "scientific-notation": {
    howTo: {
      title: "كيفية تحويل الترميز العلمي",
      steps: [
  ...
  "fraction-decimal": {
    howTo: {
      title: "كيفية تحويل الكسور إلى عشريات",
      steps: [
  ...
  "color-contrast-checker": {
    howTo: {
      title: "كيفية التحقق من تباين الألوان",
      steps: [
  ...
  "color-blindness-simulator": {
    howTo: {
      title: "كيفية محاكاة عمى الألوان",
      steps: [
  ...
  "json-yaml": {
    howTo: {
      title: "كيفية تحويل JSON إلى YAML",
      steps: [
  ...
  "json-csv": {
    howTo: {
      title: "كيفية تحويل JSON إلى CSV",
      steps: [
  ...
  "json-xml": {
    howTo: {
      title: "كيفية تحويل JSON إلى XML",
      steps: [
  ...
  "json-toml": {
    howTo: {
      title: "كيفية تحويل JSON إلى TOML",
      steps: [
  ...
  "markdown-html": {
    howTo: {
      title: "كيفية تحويل Markdown إلى HTML",
      steps: [
  ...
  "sql-json": {
    howTo: {
      title: "كيفية تحويل SQL إلى JSON",
      steps: [
  ...
  "cooking-measurement": {
    howTo: {
      title: "كيفية تحويل قياسات الطهي",
      steps: [
  ...
  "oven-temperature": {
    howTo: {
      title: "كيفية تحويل درجة حرارة الفرن",
      steps: [
