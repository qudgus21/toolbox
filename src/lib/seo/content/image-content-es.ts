...
export const imageContentEs: ToolContentMap = {
  resize: {
    howTo: {
      title: "Cómo Cambiar el Tamaño de una Imagen",
      steps: [
  ...
  "png-to-jpg": {
    howTo: {
      title: "Cómo Convertir PNG a JPG",
      steps: [
  ...
  "jpg-to-webp": {
    howTo: {
      title: "Cómo Convertir JPG a WebP",
      steps: [
        "Upload your JPG image to the converter",
  ...
  "png-to-webp": {
    howTo: {
      title: "Cómo Convertir PNG a WebP",
      steps: [
        "Select and upload your PNG image",
  ...
  "svg-to-png": {
    howTo: {
      title: "Cómo Convertir SVG a PNG",
      steps: [
  ...
  "svg-to-jpg": {
    howTo: {
      title: "Cómo Convertir SVG a JPG",
      steps: [
  ...
  "gif-to-jpg": {
    howTo: {
      title: "Cómo Convertir GIF a JPG",
      steps: [
  ...
  "bmp-to-jpg": {
    howTo: {
      title: "Cómo Convertir BMP a JPG",
      steps: [
  ...
  "bmp-to-png": {
    howTo: {
      title: "Cómo Convertir BMP a PNG",
      steps: [
  ...
  grayscale: {
    howTo: {
      title: "Cómo Convertir Imagen a Escala de Grises",
      steps: [
  ...
  "add-text": {
    howTo: {
      title: "Cómo Añadir Texto a una Imagen",
      steps: [
  ...
  "add-border": {
    howTo: {
      title: "Cómo Añadir un Borde a una Imagen",
      steps: [
  ...
  "color-replace": {
    howTo: {
      title: "Cómo Reemplazar Color en Imagen",
      steps: [
  ...
  "round-image": {
    howTo: {
      title: "Cómo Redondear Esquinas de Imagen",
      steps: [
  ...
  "profile-photo": {
    howTo: {
      title: "Cómo Crear Foto de Perfil",
      steps: [
  ...
  "image-to-icon": {
    howTo: {
      title: "Cómo Convertir Imagen a Icono",
      steps: [
  ...
  "color-palette": {
    howTo: {
      title: "Cómo Extraer Paleta de Colores",
      steps: [
  ...
  "html-to-image": {
    howTo: {
      title: "Cómo Convertir HTML a Imagen",
      steps: [
  ...
  "tiff-to-jpg": {
    howTo: {
      title: "Cómo Convertir TIFF a JPG",
      steps: [
  ...
  "tiff-to-png": {
    howTo: {
      title: "Cómo Convertir TIFF a PNG",
      steps: [
  ...
  "psd-to-jpg": {
    howTo: {
      title: "Cómo Convertir PSD a JPG",
      steps: [
  ...
  "psd-to-png": {
    howTo: {
      title: "Cómo Convertir PSD a PNG",
      steps: [
  ...
  "eps-to-jpg": {
    howTo: {
      title: "Cómo Convertir EPS a JPG",
      steps: [
  ...
  "eps-to-png": {
    howTo: {
      title: "Cómo Convertir EPS a PNG",
      steps: [
  ...
  "eps-to-svg": {
    howTo: {
      title: "Cómo Convertir EPS a SVG",
      steps: [
        "Upload your EPS file to the converter",
  ...
  "jpg-to-svg": {
    howTo: {
      title: "Cómo Convertir JPG a SVG",
      steps: [
