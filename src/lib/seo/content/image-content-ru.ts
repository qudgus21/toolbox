...
export const imageContentRu: ToolContentMap = {
  resize: {
    howTo: {
      title: "Как изменить размер изображения",
      steps: [
  ...
  crop: {
    howTo: {
      title: "Как обрезать изображение",
      steps: [
  ...
  rotate: {
    howTo: {
      title: "Как повернуть изображение",
      steps: [
  ...
  flip: {
    howTo: {
      title: "Как отразить изображение",
      steps: [
  ...
  "photo-editor": {
    howTo: {
      title: "Как редактировать фотографии",
      steps: [
  ...
  "jpg-to-png": {
    howTo: {
      title: "Как преобразовать JPG в PNG",
      steps: [
  ...
  "png-to-jpg": {
    howTo: {
      title: "Как преобразовать PNG в JPG",
      steps: [
  ...
  "webp-to-jpg": {
    howTo: {
      title: "Как преобразовать WebP в JPG",
      steps: [
  ...
  "webp-to-png": {
    howTo: {
      title: "Как преобразовать WebP в PNG",
      steps: [
  ...
  "jpg-to-webp": {
    howTo: {
      title: "Как преобразовать JPG в WebP",
      steps: [
        "Upload your JPG image to the converter",
  ...
  "png-to-webp": {
    howTo: {
      title: "Как преобразовать PNG в WebP",
      steps: [
        "Select and upload your PNG image",
  ...
  "svg-to-png": {
    howTo: {
      title: "Как преобразовать SVG в PNG",
      steps: [
  ...
  "svg-to-jpg": {
    howTo: {
      title: "Как преобразовать SVG в JPG",
      steps: [
  ...
  "gif-to-jpg": {
    howTo: {
      title: "Как преобразовать GIF в JPG",
      steps: [
  ...
  "bmp-to-jpg": {
    howTo: {
      title: "Как преобразовать BMP в JPG",
      steps: [
  ...
  "bmp-to-png": {
    howTo: {
      title: "Как преобразовать BMP в PNG",
      steps: [
  ...
  grayscale: {
    howTo: {
      title: "Как преобразовать изображение в оттенки серого",
      steps: [
  ...
  "add-text": {
    howTo: {
      title: "Как добавить текст на изображение",
      steps: [
  ...
  "add-border": {
    howTo: {
      title: "Как добавить границу к изображению",
      steps: [
  ...
  pixelate: {
    howTo: {
      title: "Как пикселировать изображение",
      steps: [
  ...
  filters: {
    howTo: {
      title: "Как применить фильтры к изображению",
      steps: [
  ...
  "color-replace": {
    howTo: {
      title: "Как заменить цвет в изображении",
      steps: [
  ...
  vignette: {
    howTo: {
      title: "Как добавить виньетку на изображение",
      steps: [
  ...
  noise: {
    howTo: {
      title: "Как добавить шум на изображение",
      steps: [
  ...
  sharpen: {
    howTo: {
      title: "Как повысить резкость изображения",
      steps: [
  ...
  sepia: {
    howTo: {
      title: "Как применить фильтр сепия",
      steps: [
  ...
  invert: {
    howTo: {
      title: "Как инвертировать цвета изображения",
      steps: [
  ...
  combine: {
    howTo: {
      title: "Как объединить изображения",
      steps: [
  ...
  "split-image": {
    howTo: {
      title: "Как разделить изображение",
      steps: [
  ...
  "round-image": {
    howTo: {
      title: "Как скруглить углы изображения",
      steps: [
  ...
  "profile-photo": {
    howTo: {
      title: "Как создать фото профиля",
      steps: [
  ...
  "image-to-icon": {
    howTo: {
      title: "Как преобразовать изображение в значок",
      steps: [
  ...
  "color-palette": {
    howTo: {
      title: "Как извлечь палитру цветов",
      steps: [
  ...
  "html-to-image": {
    howTo: {
      title: "Как преобразовать HTML в изображение",
      steps: [
  ...
  "heic-to-jpg": {
    howTo: {
      title: "Как преобразовать HEIC в JPG",
      steps: [
  ...
  "heic-to-png": {
    howTo: {
      title: "Как преобразовать HEIC в PNG",
      steps: [
  ...
  "tiff-to-jpg": {
    howTo: {
      title: "Как преобразовать TIFF в JPG",
      steps: [
  ...
  "tiff-to-png": {
    howTo: {
      title: "Как преобразовать TIFF в PNG",
      steps: [
  ...
  "psd-to-jpg": {
    howTo: {
      title: "Как преобразовать PSD в JPG",
      steps: [
  ...
  "psd-to-png": {
    howTo: {
      title: "Как преобразовать PSD в PNG",
      steps: [
  ...
  "eps-to-jpg": {
    howTo: {
      title: "Как преобразовать EPS в JPG",
      steps: [
  ...
  "eps-to-png": {
    howTo: {
      title: "Как преобразовать EPS в PNG",
      steps: [
  ...
  "eps-to-svg": {
    howTo: {
      title: "Как преобразовать EPS в SVG",
      steps: [
        "Upload your EPS file to the converter",
  ...
  "png-to-svg": {
    howTo: {
      title: "Как преобразовать PNG в SVG",
      steps: [
  ...
  "jpg-to-svg": {
    howTo: {
      title: "Как преобразовать JPG в SVG",
      steps: [
  ...
  "image-to-text": {
    howTo: {
      title: "Как извлечь текст из изображения",
      steps: [
