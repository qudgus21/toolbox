...
export const imageContentPt: ToolContentMap = {
  resize: {
    howTo: {
  ...
  "jpg-to-png": {
    howTo: {
      title: "Como Converter JPG para PNG",
      steps: [
  ...
  "png-to-jpg": {
    howTo: {
      title: "Como Converter PNG para JPG",
      steps: [
  ...
  "webp-to-jpg": {
    howTo: {
      title: "Como Converter WebP para JPG",
      steps: [
  ...
  "webp-to-png": {
    howTo: {
      title: "Como Converter WebP para PNG",
      steps: [
  ...
  "jpg-to-webp": {
    howTo: {
      title: "Como Converter JPG para WebP",
      steps: [
        "Upload your JPG image to the converter",
  ...
  "png-to-webp": {
    howTo: {
      title: "Como Converter PNG para WebP",
      steps: [
        "Select and upload your PNG image",
  ...
  "svg-to-png": {
    howTo: {
      title: "Como Converter SVG para PNG",
      steps: [
  ...
  "svg-to-jpg": {
    howTo: {
      title: "Como Converter SVG para JPG",
      steps: [
  ...
  "gif-to-jpg": {
    howTo: {
      title: "Como Converter GIF para JPG",
      steps: [
  ...
  "bmp-to-jpg": {
    howTo: {
      title: "Como Converter BMP para JPG",
      steps: [
  ...
  "bmp-to-png": {
    howTo: {
      title: "Como Converter BMP para PNG",
      steps: [
  ...
  grayscale: {
    howTo: {
      title: "Como Converter Imagem para Escala de Cinza",
      steps: [
  ...
  "add-text": {
    howTo: {
      title: "Como Adicionar Texto à Imagem",
      steps: [
  ...
  "add-border": {
    howTo: {
      title: "Como Adicionar Borda à Imagem",
      steps: [
  ...
  pixelate: {
    howTo: {
      title: "Como Pixelizar uma Imagem",
      steps: [
  ...
  blur: {
    howTo: {
      title: "Como Desfocar uma Imagem",
      steps: [
  ...
  filters: {
    howTo: {
      title: "Como Aplicar Filtros à Imagem",
      steps: [
  ...
  "color-replace": {
    howTo: {
      title: "Como Substituir Cor em Imagem",
      steps: [
  ...
  vignette: {
    howTo: {
      title: "Como Adicionar Vinheta a uma Imagem",
      steps: [
  ...
  noise: {
    howTo: {
      title: "Como Adicionar Ruído à Imagem",
      steps: [
  ...
  "round-image": {
    howTo: {
      title: "Como Arredondar Cantos da Imagem",
      steps: [
  ...
  "image-to-icon": {
    howTo: {
      title: "Como Converter Imagem em Ícone",
      steps: [
  ...
  "color-palette": {
    howTo: {
      title: "Como Extrair Paleta de Cores",
      steps: [
  ...
  "html-to-image": {
    howTo: {
      title: "Como Converter HTML para Imagem",
      steps: [
  ...
  watermark: {
    howTo: {
      title: "Como Adicionar Marca d'Água a uma Imagem",
      steps: [
  ...
  "heic-to-jpg": {
    howTo: {
      title: "Como Converter HEIC para JPG",
      steps: [
  ...
  "heic-to-png": {
    howTo: {
      title: "Como Converter HEIC para PNG",
      steps: [
  ...
  "tiff-to-jpg": {
    howTo: {
      title: "Como Converter TIFF para JPG",
      steps: [
  ...
  "tiff-to-png": {
    howTo: {
      title: "Como Converter TIFF para PNG",
      steps: [
  ...
  "psd-to-jpg": {
    howTo: {
      title: "Como Converter PSD para JPG",
      steps: [
  ...
  "psd-to-png": {
    howTo: {
      title: "Como Converter PSD para PNG",
      steps: [
  ...
  "eps-to-jpg": {
    howTo: {
      title: "Como Converter EPS para JPG",
      steps: [
  ...
  "eps-to-png": {
    howTo: {
      title: "Como Converter EPS para PNG",
      steps: [
  ...
  "eps-to-svg": {
    howTo: {
      title: "Como Converter EPS para SVG",
      steps: [
        "Upload your EPS file to the converter",
  ...
  "png-to-svg": {
    howTo: {
      title: "Como Converter PNG para SVG",
      steps: [
  ...
  "jpg-to-svg": {
    howTo: {
      title: "Como Converter JPG para SVG",
      steps: [
  ...
  "image-to-text": {
    howTo: {
      title: "Como Extrair Texto de Imagem",
      steps: [
