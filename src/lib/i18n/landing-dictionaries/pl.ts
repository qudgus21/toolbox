...
const dict: LandingDictionary = {
  ...
  hero: {
    badge: "176+ darmowych narzędzi online",
  ...
  trust: {
    ...
    browserBased: "Przetwarzanie w przeglądarce",
    browserBasedDesc: "Twoje pliki nigdy nie opuszczają urządzenia. Wszystko działa w przeglądarce — szybko i bezpiecznie.",
    free: "Całkowicie za darmo",
    freeDesc: "Korzystaj z każdego narzędzia bez ograniczeń. Żadnych ukrytych opłat.",
    private: "Prywatność przede wszystkim",
    privateDesc: "Pliki zostają na Twoim urządzeniu. Nic nie trafia na serwer — Twoje dane należą do Ciebie.",
