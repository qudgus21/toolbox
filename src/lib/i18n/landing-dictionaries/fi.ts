...
const dict: LandingDictionary = {
  ...
  common: { shareTitle: "Jaa", shareSubtitle: "Kerro kavereillesi ToolPopista!", shareCopyLink: "Kopioi linkki", shareCopied: "Kopioitu!", ariaClose: "Sulje", ariaMenu: "Valikko", ariaShare: "Jaa" },
