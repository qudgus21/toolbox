...
const dict: LandingDictionary = {
  meta: {
    ...
    description: "Muokkaa, yhdistä ja muunna PDF-tiedostoja. Muuta kokoa, pakkaa ja käsittele kuvia. Kaikki ilmaiseksi, suoraan selaimessa.",
  },
  hero: {
    badge: "131+ ilmaista verkkotyökalua",
    title: "Kaikki tarvitsemasi työkalut yhdessä paikassa — ToolPop",
    titleAccent: "ToolPop",
    subtitle: "Käsittele PDF-tiedostoja ja kuvia suoraan selaimessa. Ei asennuksia, ei rekisteröitymistä.",
  ...
  stats: { tools: "131+", toolsLabel: "Ilmaista työkalua", languages: "45", languagesLabel: "Kieltä", users: "100%", usersLabel: "Selainpohjainen", price: "0 €", priceLabel: "Ilmainen aina" },
  trust: {
  ...
  nav: { pdf: "PDF", image: "Kuva", text: "Teksti" },
};
export default dict;
