...
const dict: LandingDictionary = {
  ...
  hero: {
    badge: "87+ ilmaista verkkotyökalua",
  ...
  stats: { tools: "87+", toolsLabel: "Ilmaista työkalua", languages: "45", languagesLabel: "Kieltä", users: "100%", usersLabel: "Selainpohjainen", price: "0 €", priceLabel: "Ilmainen aina" },
  trust: {
