...
const dict: LandingDictionary = {
  ...
  apps: {
    ...
    converter: { name: "Інструменти конвертації", description: "Конвертуйте одиниці, кольори, формати даних, дати та багато іншого.", cta: "Конвертери", toolCount: "45 інструментів" },
  },
  ...
  nav: { pdf: "PDF", image: "Зображення", text: "Текст", converter: "Конвертер" },
};
export default dict;
