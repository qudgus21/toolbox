...
const dict: LandingDictionary = {
  ...
  stats: { tools: "87+", toolsLabel: "Gratisverktyg", languages: "45", languagesLabel: "Språk", users: "100%", usersLabel: "I webbläsaren", price: "0 kr", priceLabel: "Gratis för alltid" },
  trust: {
