...
const dict: LandingDictionary = {
  ...
  hero: {
    badge: "176+ ücretsiz çevrimiçi araç",
  ...
  apps: {
    ...
    converter: { name: "Dönüştürme Araçları", description: "Birimleri, renkleri, veri formatlarını, tarihleri ve daha fazlasını anında dönüştürün.", cta: "Dönüştürücüleri Keşfet", toolCount: "45 araç" },
    calculator: { name: "Hesap Makineleri", description: "Matematik, finans, sağlık ve günlük hesaplamalar — hızlı ve ücretsiz.", cta: "Hesap Makinelerini Keşfet", toolCount: "30+ araç" },
  },
  popularTools: { sectionTitle: "Popüler Araçlar", sectionSubtitle: "En çok kullanılan araçlara hemen geç", viewAll: "Tümünü gör" },
  stats: { tools: "176+", toolsLabel: "Ücretsiz Araç", languages: "45", languagesLabel: "Dil", users: "100%", usersLabel: "Tarayıcı Tabanlı", price: "$0", priceLabel: "Sonsuza dek ücretsiz" },
  trust: {
