...
const dict: LandingDictionary = {
  ...
  apps: {
    ...
    converter: { name: "Dönüştürme Araçları", description: "Birimleri, renkleri, veri formatlarını, tarihleri ve daha fazlasını anında dönüştürün.", cta: "Dönüştürücüler", toolCount: "45 araç" },
  },
  ...
  nav: { pdf: "PDF", image: "Görsel", text: "Metin", converter: "Dönüştür" },
};
export default dict;
