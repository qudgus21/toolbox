...
const dict: LandingDictionary = {
  ...
  trust: {
    ...
    freeDesc: "সব টুল যতবার খুশি ব্যবহার করুন, কোনো সীমা নেই। কোনো লুকানো চার্জ নেই, কখনোই না।",
    private: "গোপনীয়তা সর্বাগ্রে",
    privateDesc: "প্রসেসিং শেষ হওয়া মাত্রই ফাইল মুছে ফেলা হয়। আমরা কিছুই সংগ্রহ বা সংরক্ষণ করি না।",
    noSignup: "সাইন-আপের দরকার নেই",
    noSignupDesc: "অ্যাকাউন্ট লাগবে না, ইমেইল লাগবে না। টুল খুলুন, কাজ শুরু করুন।",
  },
  cta: {
