...
const dict: LandingDictionary = {
  meta: {
    ...
    description: "PDF szerkesztés, egyesítés, konvertálás. Képek átméretezése, tömörítése, átalakítása. Minden ingyenes, közvetlenül a böngészőben.",
  },
  hero: {
    badge: "131+ ingyenes online eszköz",
    title: "Minden eszköz, amire szükséged van, egyetlen ToolPop",
    titleAccent: "ToolPop",
    subtitle: "Dolgozz PDF-ekkel és képekkel közvetlenül a böngészőben. Telepítés és regisztráció nélkül.",
  ...
  stats: { tools: "131+", toolsLabel: "Ingyenes eszköz", languages: "45", languagesLabel: "Nyelv", users: "100%", usersLabel: "Böngészőalapú", price: "0 Ft", priceLabel: "Örökké ingyenes" },
  trust: {
  ...
  nav: { pdf: "PDF", image: "Kép", text: "Szöveg" },
};
export default dict;
