...
const dict: LandingDictionary = {
  ...
  hero: {
    badge: "87+ ingyenes online eszköz",
  ...
  stats: { tools: "87+", toolsLabel: "Ingyenes eszköz", languages: "45", languagesLabel: "Nyelv", users: "100%", usersLabel: "Böngészőalapú", price: "0 Ft", priceLabel: "Örökké ingyenes" },
  trust: {
