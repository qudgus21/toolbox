...
const dict: LandingDictionary = {
  ...
  hero: {
    badge: "176+ ingyenes online eszköz",
  ...
  trust: {
    ...
    browserBased: "Böngészőben fut",
    browserBasedDesc: "A fájljaid soha nem hagyják el az eszközödet. Minden a böngészőben történik — gyorsan és biztonságosan.",
    free: "Teljesen ingyenes",
    freeDesc: "Használj bármilyen eszközt, ahányszor csak akarod, korlátozás nélkül. Nincsenek rejtett díjak.",
    private: "Adatvédelem az első",
    privateDesc: "A fájlok az eszközödön maradnak. Nincs szerverre feltöltés, az adataid a tieid maradnak.",
