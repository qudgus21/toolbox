...
const dict: LandingDictionary = {
  ...
  trust: {
    ...
    browserBased: "Proċessar fil-Browser",
    browserBasedDesc: "Il-fajls tiegħek qatt ma jitilqu mill-apparat tiegħek. Kollox jaħdem fil-browser — malajr u sigur.",
    free: "Kompletament B'Xejn",
    freeDesc: "Uża kull għodda kemm trid, bla limiti. L-ebda ħlasijiet moħbija.",
    private: "Il-Privatezza l-Ewwel",
    privateDesc: "Il-fajls jibqgħu fuq l-apparat tiegħek. Xejn ma jittella' fuq server — id-data tiegħek tibqa' tiegħek.",
    noSignup: "Bla Reġistrazzjoni",
    noSignupDesc: "Bla kont, bla email. Iftaħ għodda u ibda aħdem.",
  },
  ...
  common: { shareTitle: "Aqsam", shareSubtitle: "Għid lil-ħbieb tiegħek dwar ToolPop!", shareCopyLink: "Ikkopja l-link", shareCopied: "Ikkopjat!", ariaClose: "Agħlaq", ariaMenu: "Menu", ariaShare: "Aqsam" },
