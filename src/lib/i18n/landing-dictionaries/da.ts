...
const dict: LandingDictionary = {
  ...
  hero: {
    badge: "87+ gratis onlineværktøjer",
  ...
  stats: { tools: "87+", toolsLabel: "Gratis værktøjer", languages: "45", languagesLabel: "Sprog", users: "100%", usersLabel: "Browserbaseret", price: "0 kr", priceLabel: "Gratis for altid" },
  trust: {
    sectionTitle: "Hvorfor ToolPop?",
    sectionSubtitle: "Sikkerhed og bekvemmelighed uden kompromis",
    browserBased: "Behandling i browseren",
    browserBasedDesc: "Dine filer forlader aldrig din enhed. Alt kører i browseren — hurtigt og sikkert.",
    free: "Helt gratis",
    freeDesc: "Brug ethvert værktøj så mange gange du vil, uden begrænsninger. Ingen skjulte gebyrer.",
    private: "Privatliv først",
    privateDesc: "Filerne forbliver på din enhed. Ingen upload til servere betyder, at dine data forbliver dine.",
    noSignup: "Ingen tilmelding nødvendig",
    noSignupDesc: "Ingen konto, ingen e-mail. Bare åbn et værktøj og kom i gang.",
  },
