...
const dict: LandingDictionary = {
  ...
  trust: {
    ...
    browserBased: "Επεξεργασία στον Browser",
    browserBasedDesc: "Τα αρχεία σου δεν φεύγουν από τη συσκευή σου. Όλα τρέχουν στον browser — γρήγορα και ασφαλή.",
    free: "Εντελώς Δωρεάν",
    freeDesc: "Χρησιμοποίησε κάθε εργαλείο όσες φορές θέλεις, χωρίς περιορισμούς. Κανένα κρυφό κόστος.",
    private: "Προτεραιότητα στο Απόρρητο",
    privateDesc: "Τα αρχεία μένουν στη συσκευή σου. Χωρίς ανέβασμα σε server, τα δεδομένα σου παραμένουν δικά σου.",
