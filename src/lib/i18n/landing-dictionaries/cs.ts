...
const dict: LandingDictionary = {
  ...
  hero: {
    badge: "176+ bezplatných online nástrojů",
  ...
  trust: {
    ...
    browserBased: "Zpracování v prohlížeči",
    browserBasedDesc: "Vaše soubory nikdy neopustí vaše zařízení. Vše běží v prohlížeči — rychle a bezpečně.",
    free: "Zcela zdarma",
    freeDesc: "Používejte libovolný nástroj, kolikrát chcete, bez omezení. Žádné skryté poplatky.",
    private: "Soukromí na prvním místě",
    privateDesc: "Soubory zůstávají na vašem zařízení. Žádné nahrávání na server znamená, že vaše data zůstávají vaše.",
    noSignup: "Bez registrace",
    noSignupDesc: "Žádný účet, žádný e-mail. Prostě otevřete nástroj a začněte pracovat.",
  },
  ...
  common: { shareTitle: "Sdílet", shareSubtitle: "Řekněte o ToolPop svým přátelům!", shareCopyLink: "Kopírovat odkaz", shareCopied: "Zkopírováno!", ariaClose: "Zavřít", ariaMenu: "Nabídka", ariaShare: "Sdílet" },
