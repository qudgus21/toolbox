...
const dict: LandingDictionary = {
  ...
  trust: {
    ...
    browserBased: "Verwerking in de browser",
    browserBasedDesc: "Je bestanden verlaten nooit je apparaat. Alles draait in je browser — snel en veilig.",
    free: "Helemaal gratis",
    freeDesc: "Gebruik elke tool zo vaak als je wilt, zonder beperkingen. Geen verborgen kosten.",
    private: "Privacy voorop",
    privateDesc: "Bestanden blijven op jouw apparaat. Geen uploads naar servers — je gegevens blijven van jou.",
    noSignup: "Geen registratie nodig",
    noSignupDesc: "Geen account, geen e-mail. Open een tool en ga direct aan de slag.",
  },
  ...
  common: { shareTitle: "Delen", shareSubtitle: "Vertel je vrienden over ToolPop!", shareCopyLink: "Link kopiëren", shareCopied: "Gekopieerd!", ariaClose: "Sluiten", ariaMenu: "Menu", ariaShare: "Delen" },
