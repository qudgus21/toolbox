...
const dict: LandingDictionary = {
  ...
  hero: {
    badge: "176+ nemokamų internetinių įrankių",
  ...
  trust: {
    ...
    browserBased: "Apdorojimas naršyklėje",
    browserBasedDesc: "Jūsų failai niekada nepalieka jūsų įrenginio. Viskas veikia naršyklėje — greitai ir saugiai.",
    free: "Visiškai nemokamai",
    freeDesc: "Naudokite visus įrankius kiek norite, be jokių apribojimų. Jokių paslėptų mokesčių.",
    private: "Privatumas svarbiausia",
    privateDesc: "Failai lieka jūsų įrenginyje. Jokio įkėlimo į serverį — jūsų duomenys priklauso tik jums.",
