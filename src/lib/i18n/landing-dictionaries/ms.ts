...
const dict: LandingDictionary = {
  ...
  hero: {
    badge: "176+ alat dalam talian percuma",
  ...
  trust: {
    ...
    browserBased: "Diproses dalam Pelayar",
    browserBasedDesc: "Fail anda tidak pernah meninggalkan peranti anda. Semuanya berjalan dalam pelayar — pantas dan selamat.",
    free: "Sepenuhnya Percuma",
    freeDesc: "Gunakan semua alat sesuka hati, tanpa had. Tiada caj tersembunyi.",
    private: "Privasi Diutamakan",
    privateDesc: "Fail kekal dalam peranti anda. Tiada muat naik ke pelayan — data anda kekal milik anda.",
    noSignup: "Tanpa Pendaftaran",
    noSignupDesc: "Tanpa akaun, tanpa e-mel. Buka sahaja alat dan mula bekerja.",
  },
  ...
  common: { shareTitle: "Kongsi", shareSubtitle: "Beritahu rakan anda tentang ToolPop!", shareCopyLink: "Salin pautan", shareCopied: "Disalin!", ariaClose: "Tutup", ariaMenu: "Menu", ariaShare: "Kongsi" },
