...
const dict: LandingDictionary = {
  ...
  apps: {
    ...
    converter: { name: "Strumenti di conversione", description: "Converti unità, colori, formati dati, date e altro all'istante.", cta: "Scopri i convertitori", toolCount: "45 strumenti" },
    calculator: { name: "Calcolatrici", description: "Matematica, finanza, salute e calcoli quotidiani — veloci e gratuiti.", cta: "Scopri le calcolatrici", toolCount: "30+ strumenti" },
  },
