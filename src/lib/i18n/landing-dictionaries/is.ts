...
const dict: LandingDictionary = {
  ...
  trust: {
    ...
    browserBased: "Úrvinnsla í vafranum",
    browserBasedDesc: "Skrárnar þínar fara aldrei af tækinu þínu. Allt keyrir í vafranum — hratt og öruggt.",
    free: "Algjörlega ókeypis",
    freeDesc: "Notaðu öll verkfæri eins oft og þú vilt, án takmarkana. Engin falin gjöld.",
    private: "Friðhelgi í fyrirrúmi",
    privateDesc: "Skrár verða áfram á tækinu þínu. Ekkert er hlaðið upp á netþjón — gögnin þín tilheyra þér.",
    noSignup: "Engin nýskráning",
    noSignupDesc: "Enginn reikningur, ekkert netfang. Opnaðu verkfæri og byrjaðu strax.",
  },
