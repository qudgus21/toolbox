...
const dict: LandingDictionary = {
  ...
  stats: { tools: "87+", toolsLabel: "Alat Gratis", languages: "45", languagesLabel: "Bahasa", users: "100%", usersLabel: "Berbasis Browser", price: "Rp0", priceLabel: "Gratis Selamanya" },
  trust: {
    sectionTitle: "Kenapa ToolPop?",
    sectionSubtitle: "Keamanan dan kemudahan tanpa kompromi",
    browserBased: "Diproses di Browser",
    browserBasedDesc: "File kamu tidak pernah meninggalkan perangkatmu. Semua berjalan di browser — cepat dan aman.",
    free: "Sepenuhnya Gratis",
    freeDesc: "Gunakan semua alat sesuka hati, tanpa batasan. Tidak ada biaya tersembunyi.",
    private: "Privasi Utama",
    privateDesc: "File tetap di perangkatmu. Tidak ada upload ke server — datamu tetap milikmu.",
