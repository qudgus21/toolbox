...
const dict: LandingDictionary = {
  ...
  stats: { tools: "87+", toolsLabel: "ఉచిత టూల్స్", languages: "45", languagesLabel: "భాషలు", users: "100%", usersLabel: "బ్రౌజర్-ఆధారిత", price: "₹0", priceLabel: "ఎల్లప్పుడూ ఉచితం" },
  trust: {
