...
const dict: LandingDictionary = {
  ...
  common: { shareTitle: "షేర్ చేయండి", shareSubtitle: "మీ స్నేహితులకు ToolPop గురించి చెప్పండి!", shareCopyLink: "లింక్ కాపీ చేయండి", shareCopied: "కాపీ అయింది!", ariaClose: "మూసివేయి", ariaMenu: "మెనూ", ariaShare: "షేర్" },
