...
const dict: LandingDictionary = {
  ...
  stats: { tools: "131+", toolsLabel: "मोफत साधने", languages: "45", languagesLabel: "भाषा", users: "100%", usersLabel: "ब्राउझर-आधारित", price: "₹0", priceLabel: "कायमचे मोफत" },
  trust: {
  ...
  nav: { pdf: "PDF", image: "चित्र", text: "मजकूर" },
};
export default dict;
