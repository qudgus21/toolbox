...
const dict: LandingDictionary = {
  ...
  hero: {
    badge: "176+ kostenlose Online-Tools",
  ...
  trust: {
    ...
    browserBased: "Verarbeitung im Browser",
    browserBasedDesc: "Deine Dateien verlassen nie dein Gerät. Alles läuft direkt im Browser — schnell und sicher.",
    free: "Komplett kostenlos",
    freeDesc: "Nutze jedes Tool so oft du willst, ohne Einschränkungen. Keine versteckten Kosten.",
    private: "Datenschutz an erster Stelle",
    privateDesc: "Dateien bleiben auf deinem Gerät. Kein Server-Upload — deine Daten gehören dir.",
