...
const dict: LandingDictionary = {
  ...
  hero: {
    ...
    titleAccent: "ToolPop",
    subtitle:
      "Trabaja con PDFs, imágenes, texto y conversiones directamente en tu navegador. Sin instalaciones, sin registros.",
  ...
  footer: {
    ...
    copyright: "© 2026 ToolPop. Todos los derechos reservados.",
