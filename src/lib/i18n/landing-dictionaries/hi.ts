...
const dict: LandingDictionary = {
  ...
  trust: {
    ...
    freeDesc: "हर टूल जितनी बार चाहें इस्तेमाल करें, कोई सीमा नहीं। कोई छुपी फ़ीस नहीं, कभी नहीं।",
    private: "प्राइवेसी सबसे पहले",
    privateDesc: "प्रोसेसिंग पूरी होते ही फ़ाइलें डिलीट हो जाती हैं। हम कुछ भी कलेक्ट या स्टोर नहीं करते।",
    noSignup: "साइन-अप की ज़रूरत नहीं",
    noSignupDesc: "अकाउंट नहीं चाहिए, ईमेल नहीं चाहिए। टूल खोलें और सीधे काम शुरू करें।",
  },
  cta: {
