...
const dict: LandingDictionary = {
  ...
  hero: {
    badge: "176+ uirlis ar líne saor in aisce",
  ...
  trust: {
    ...
    browserBased: "Próiseáil sa Bhrabhsálaí",
    browserBasedDesc: "Ní fhágann do chuid comhad do ghléas riamh. Ritheann gach rud i do bhrabhsálaí — go tapa agus go slán.",
    free: "Saor in Aisce ar Fad",
    freeDesc: "Úsáid gach uirlis chomh minic is mian leat, gan teorainn. Gan aon táillí folaithe.",
    private: "Príobháideachas ar Dtús",
    privateDesc: "Fanann comhaid ar do ghléas. Gan uaslódáil chuig freastalaí — is leatsa do chuid sonraí.",
    noSignup: "Gan Clárú",
