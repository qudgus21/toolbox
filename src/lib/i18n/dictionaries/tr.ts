...
const tr: Dictionary = {
  ...
  common: {
    ...
    errorNoPages: "Sayfa seçilmedi",
    errorNoValidPages: "Geçerli sayfa seçilmedi",
    errorCannotDeleteAll: "Tüm sayfalar silinemez",
    errorCannotExtractAll: "Tüm sayfalar çıkarılamaz — doğrudan indirmeyi kullanın",
    errorTwoFilesRequired: "İki PDF dosyası gerekli",
    errorNoRedactions: "Karartma alanı belirtilmedi",
    errorCannotRemoveAll: "Tüm sayfalar kaldırılamaz",
