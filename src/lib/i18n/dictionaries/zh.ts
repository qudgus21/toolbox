...
const zh: Dictionary = {
  ...
  common: {
    ...
    errorNoFile: "未提供文件",
    errorNoPages: "未选择页面",
    errorNoValidPages: "未选择有效页面",
    errorCannotDeleteAll: "无法删除所有页面",
    errorCannotExtractAll: "无法提取所有页面，请直接下载",
    errorTwoFilesRequired: "需要两个PDF文件",
    errorNoRedactions: "未指定涂黑区域",
    errorCannotRemoveAll: "无法移除所有页面",
    unknownError: "发生未知错误",
    pagesSelected: "页已选择",
    selectAll: "全选",
    deselectAll: "取消全选",
  ...
  pdfToPngTool: {
    ...
    qualityHighDesc: "清晰图片，文件较大",
    qualityMedium: "标准",
    qualityMediumDesc: "分辨率与文件大小的平衡",
    qualityLow: "低分辨率",
    qualityLowDesc: "文件较小，分辨率较低",
    convertInfo: "PNG 是支持透明度的无损格式",
    convertButton: "转换为 PNG",
  },
  pdfToTextTool: {
    description: "自动从 PDF 提取文本并转换为文本文件",
    pageBreakNote: "页面之间自动插入分页符",
    encodingNote: "以 UTF-8 编码保存",
    convertButton: "提取文本",
  },
  extractImagesTool: {
    dropFile: "选择PDF文件",
  ...
  redactTool: {
    ...
    pageLabel: "页面",
    pageOf: "{n} / {total}",
    deleteRedaction: "删除涂黑",
    redactionList: "涂黑列表",
    noRedactions: "尚无涂黑。绘制区域或搜索文本进行涂黑。",
    redactionsOnPage: "第 {page} 页",
    areaRedaction: "区域",
    textRedaction: "文本",
    changeFile: "更换文件",
    applyButton: "应用涂黑",
    applyWarning: "应用涂黑将永久删除相关内容",
    clickToDraw: "拖动绘制涂黑区域",
    confirmClearAll: "删除所有涂黑？",
    position: "位置",
    size: "大小",
    patternDetect: "自动检测",
    patternCreditCard: "信用卡",
    patternPhone: "电话",
    patternEmail: "邮箱",
    patternScanning: "正在扫描文档...",
    patternFound: "检测到 {count} 处",
    patternNone: "未检测到",
    redactSelected: "涂黑选中项",
    redactFullPage: "整页涂黑",
    redactFullPageDesc: "涂黑选中的整个页面",
    currentPage: "当前页",
    allPages: "所有页面",
    oddPages: "奇数页",
    evenPages: "偶数页",
    customPages: "自定义页面",
    customPagesPlaceholder: "例如 1, 3-5, 8",
