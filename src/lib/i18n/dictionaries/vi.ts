...
const vi: Dictionary = {
  ...
  common: {
    ...
    errorNoFile: "Chưa chọn tệp",
    errorNoPages: "Chưa chọn trang nào",
    errorNoValidPages: "Không có trang hợp lệ nào được chọn",
    errorCannotDeleteAll: "Không thể xóa tất cả các trang",
    errorCannotExtractAll: "Không thể trích xuất tất cả các trang — hãy tải xuống trực tiếp",
    errorTwoFilesRequired: "Cần hai tệp PDF",
    errorNoRedactions: "Chưa chỉ định vùng che mờ",
    errorCannotRemoveAll: "Không thể xóa tất cả các trang",
