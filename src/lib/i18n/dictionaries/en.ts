...
const en: Dictionary = {
  ...
  common: {
    ...
    errorNoPages: "No pages selected",
    errorNoValidPages: "No valid pages selected",
    errorCannotDeleteAll: "Cannot delete all pages",
    errorCannotExtractAll: "Cannot extract all pages — use download instead",
    errorTwoFilesRequired: "Two PDF files are required",
    errorNoRedactions: "No redactions specified",
    errorCannotRemoveAll: "Cannot remove all pages",
  },
  metadata: {
