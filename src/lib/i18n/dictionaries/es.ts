...
const es: Dictionary = {
  home: {
    ...
    titleAccent: "PDF",
    description:
      "Combina, divide, comprime y convierte archivos PDF. Todo se procesa en tu navegador.",
    tabAll: "Todos",
  ...
  common: {
    ...
    share: "Compartir",
    shareTitle: "Compartir esta pagina",
    shareSubtitle: "Corre la voz!",
    shareCopied: "¡Copiado!",
    shareCopyLink: "Copiar enlace",
    ariaActions: "Acciones",
    errorNoFile: "No se proporcionó ningún archivo",
    errorNoPages: "No se seleccionaron páginas",
    errorNoValidPages: "No se seleccionaron páginas válidas",
    errorCannotDeleteAll: "No se pueden eliminar todas las páginas",
    errorCannotExtractAll: "No se pueden extraer todas las páginas. Usa la descarga directa",
    errorTwoFilesRequired: "Se necesitan dos archivos PDF",
    errorNoRedactions: "No se especificaron tachaduras",
    errorCannotRemoveAll: "No se pueden eliminar todas las páginas",
  ...
  pdfToPngTool: {
    ...
    qualityMediumDesc: "Equilibrio entre resolución y tamaño",
    ...
    convertButton: "Convertir a PNG",
  },
  pdfToTextTool: {
    description: "Extrae automáticamente el texto de tu PDF y lo convierte en un archivo de texto",
    pageBreakNote: "Los saltos de página se insertan automáticamente entre páginas",
    encodingNote: "Guardado en codificación UTF-8",
  ...
  redactTool: {
    dropFile: "Seleccionar un archivo PDF",
    toolSelect: "Seleccionar",
    toolRedactArea: "Censurar área",
    toolRedactText: "Buscar texto",
    searchPlaceholder: "Texto a censurar...",
    searchButton: "Buscar",
    searchNoResults: "Sin resultados",
    searchResultCount: "{count} encontrados",
    redactAllResults: "Censurar todo",
    redactColor: "Color de censura",
    colorBlack: "Negro",
    colorWhite: "Blanco",
    colorRed: "Rojo",
    colorGray: "Gris",
    ...
    pageLabel: "Páginas",
    pageOf: "{n} / {total}",
    deleteRedaction: "Eliminar censura",
    redactionList: "Censuras",
    noRedactions: "Aún no hay censuras. Dibuja un área o busca texto para censurar.",
    redactionsOnPage: "Página {page}",
    areaRedaction: "Área",
    textRedaction: "Texto",
    changeFile: "Cambiar archivo",
    applyButton: "Aplicar censuras",
    applyWarning: "Aplicar las censuras eliminará el contenido de forma permanente",
    clickToDraw: "Arrastra para dibujar un área de censura",
    confirmClearAll: "¿Eliminar todas las censuras?",
    position: "Posición",
    size: "Tamaño",
    patternDetect: "Detección automática",
    patternCreditCard: "Tarjeta de crédito",
    patternPhone: "Teléfono",
    patternEmail: "Correo electrónico",
    patternScanning: "Escaneando documento...",
    patternFound: "{count} detectados",
    patternNone: "Nada detectado",
    redactSelected: "Censurar selección",
    redactFullPage: "Selección de páginas",
    redactFullPageDesc: "Censurar páginas completas seleccionadas",
    currentPage: "Página actual",
    allPages: "Todas las páginas",
    oddPages: "Páginas impares",
    evenPages: "Páginas pares",
    customPages: "Personalizado",
    customPagesPlaceholder: "ej. 1, 3-5, 8",
    addPageRedaction: "Añadir censura de página",
    pageRedaction: "Página completa",
  ...
  pagesPerSheetTool: {
    ...
    pageOf: "pages",
    sheets: "sheets",
    fileMode: "Distribución de archivo",
    fileModeNewSheet: "Nueva hoja por archivo",
    fileModeMerge: "Combinar continuamente",
  },
  headerFooterTool: {
  ...
  blog: {
    ...
    next: "Siguiente",
    page: "Página",
    paginationLabel: 'Navegación de páginas',
  },
  toolContent: {
    merge: {
