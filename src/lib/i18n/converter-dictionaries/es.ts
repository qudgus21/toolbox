...
const dict: ConverterDictionary = {
  home: {
    title: "Todos los conversores que necesitas",
    titleAccent: "conversores",
    description:
      "Convierte unidades, colores, formatos de datos, fechas y más, directamente en tu navegador.",
    tabAll: "Todos",
