...
const dict: ConverterDictionary = {
  home: {
    title: "Alle Umrechnungs-Tools, die du brauchst",
    titleAccent: "Umrechnungs",
    description:
      "Einheiten, Farben, Datenformate und Daten umrechnen. Alles direkt im Browser.",
    tabAll: "Alle",
