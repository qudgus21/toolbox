...
const dict: CalculatorDictionary = {
  ...
  statsLabels: {
    ...
    finalAmount: "ចំនួនចុងក្រោយ",
    monthlyKwh: "kWh ប្រចាំខែ",
    courseCount: "ចំនួនមុខវិជ្ជា",
    loanAmount: "ចំនួនប្រាក់កម្ចី",
    isPrime: "ជាលេខបឋម",
    factorCount: "ចំនួនកត្តា",
    markup: "ការដំឡើងថ្លៃ",
    profitable: "មានផលចំណេញ",
    count: "ចំនួន",
    mean: "មធ្យម",
    median: "មេដៀន",
    variance: "វ៉ារីអង់",
    standardDeviation: "គម្លាតស្តង់ដារ",
  },
  processorMessages: {
    underweight: "ស្គមពេក",
    normal: "ទម្ងន់ធម្មតា",
    ...
    "Weekly Calories": "កាឡូរីប្រចាំសប្ដាហ៍",
    "Activity Factor": "កត្តាសកម្មភាព",
    "Goal Adjustment": "ការកែតម្រូវគោលដៅ",
    "Target Calories": "កាឡូរីគោលដៅ",
    "Value (x)": "តម្លៃ (x)",
    "Percentile": "ភាគរយ",
    "P(X ≤ x)": "P(X ≤ x)",
    "P(X > x)": "P(X > x)",
    "Interpretation": "ការបកស្រាយ",
    "Number B (dec)": "លេខ B (ទសភាគ)",
    "Number B (bin)": "លេខ B (គោលពីរ)",
    "Number B (hex)": "លេខ B (គោលដប់ប្រាំមួយ)",
    "Devine": "Devine",
    "Robinson": "Robinson",
    "Miller": "Miller",
    "Wall Area": "ផ្ទៃជញ្ជាំង",
    "Deductions": "ការកាត់បន្ថយ",
    "With Coats": "ជាមួយស្រទាប់",
    "Tile Area (with gap)": "ផ្ទៃក្រឡាក្បឿង (រួមចន្លោះ)",
    "Exact Tiles": "ក្បឿងពិតប្រាកដ",
    "With Wastage": "រួមការខាតបង់",
    "Declining Rate": "អត្រាថយចុះ",
    "Year 1 Depreciation": "រំលស់ឆ្នាំទី ១",
    "Margin Formula": "រូបមន្តប្រាក់ចំណេញ",
    "Markup Formula": "រូបមន្តដំឡើងថ្លៃ",
    "Body Fat Percentage": "ភាគរយខ្លាញ់រាងកាយ",
    "Mean (x\u0304)": "មធ្យម (x\u0304)",
    "LCM = a × b / GCD": "គ.ស.ត = a × b / ឈ.ស.ធ",
    "Courses": "មុខវិជ្ជា",
    "Items": "ធាតុ",
    "Markup vs Margin": "ដំឡើងថ្លៃ ទល់នឹង ប្រាក់ចំណេញ",
    "Timeframe": "រយៈពេល",
  },
  metadata: {
