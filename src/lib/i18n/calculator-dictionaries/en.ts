...
const dict: CalculatorDictionary = {
  ...
  processorMessages: {
    ...
    "Goal Adjustment": "Goal Adjustment",
    ...
    "Number B (dec)": "Number B (dec)",
    "Number B (bin)": "Number B (bin)",
    "Number B (hex)": "Number B (hex)",
    "Devine": "Devine",
    "Robinson": "Robinson",
    "Miller": "Miller",
    "Wall Area": "Wall Area",
    "Deductions": "Deductions",
    "With Coats": "With Coats",
    "Tile Area (with gap)": "Tile Area (with gap)",
    "Exact Tiles": "Exact Tiles",
    "With Wastage": "With Wastage",
    "Declining Rate": "Declining Rate",
    "Year 1 Depreciation": "Year 1 Depreciation",
