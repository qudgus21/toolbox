...
import type { PageSizeKey, Orientation } from "@/lib/pdf/processors/png-to-pdf";

export interface PngToPdfLabels {
...
interface PngToPdfOptionsProps {
...
export function PngToPdfOptions({
  orientation,
  pageSize,
  marginMm,
  mergeAll,
