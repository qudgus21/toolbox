...
import { tools, categories } from "@/lib/calculator/tools";
...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: generateAlternates("", locales, locale, "en", "calculator"),
    openGraph: {
      title: dict.metadata.siteTitle,
      description: dict.metadata.siteDescription,
    ...
    <>
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          url: `https://toolpop.org/${locale}/calculator`,
      ...
      <LandingContentSection content={getLandingContent("calculator", locale) ?? { title: "", description: "", sections: [] }} />
