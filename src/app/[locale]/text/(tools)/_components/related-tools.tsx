...
import { tools, type TextToolDefinition } from "@/lib/text/tools";
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                "hover:border-accent/30 hover:shadow-md hover:shadow-accent/5 hover:-translate-y-0.5",
                "text-foreground-muted hover:text-foreground",
              )}
            >
              <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-accent/10 text-accent transition-colors group-hover:bg-accent/20">
